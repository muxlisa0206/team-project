  ...
  return (
   <>
     <header className='bg-[#3B3937] fixed z-99 w-full top-0'>
      <div className='container mx-auto px-[10px] py-[20px] sm:py-[25px] flex items-center justify-between'>
        ...
        <NavLink to="Catalog" className='bg-[#A9845C]  text-white text-[13px] font-bold shadow-[1px_1px_1px_0px_#00000040] rounded px-[30px] sm:px-[35px] cursor-pointer py-[5px] sm:py-[15px]'>Catalog</NavLink>
